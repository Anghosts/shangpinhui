  ...
  <div>
    ...
    <div class="content">
      ...
      <div class="way">
        ...
        <div class="info clearFix">
          ...
          <p>配送时间：预计2月30日（周八）09:00-15:00送达</p>
        </div>
      </div>
      <div class="detail">
        <h5>商品清单</h5>
        ...
        >
          <li>
            <img :src="detail.imgUrl" width="100px" />
          </li>
          <li>
            <p>
              {{ detail.skuName }}
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        <span>寄送至：{{ defaultAddress.fullAddress }}</span>
  ...
  methods: {
    ...
    submitOrder() {
      let params = {
        ...
        deliveryAddress: this.defaultAddress.fullAdress,
        paymentWay: "ONLINE",
